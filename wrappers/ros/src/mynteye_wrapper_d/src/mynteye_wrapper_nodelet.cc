...
public:
  ...
  ImuData ProcImuTempDrift(const ImuData &data) const
  {
    ...
    if (res.flag == 1)
    {
      res.accel[0] -= motion_intrinsics->accel.x[1] * temp + motion_intrinsics->accel.x[0];
      res.accel[1] -= motion_intrinsics->accel.y[1] * temp + motion_intrinsics->accel.y[0];
      res.accel[2] -= motion_intrinsics->accel.z[1] * temp + motion_intrinsics->accel.z[0];
    }
    else if (res.flag == 2)
    {
      res.gyro[0] -= motion_intrinsics->gyro.x[1] * temp + motion_intrinsics->gyro.x[0];
      res.gyro[1] -= motion_intrinsics->gyro.y[1] * temp + motion_intrinsics->gyro.y[0];
      res.gyro[2] -= motion_intrinsics->gyro.z[1] * temp + motion_intrinsics->gyro.z[0];
    }
    else if (res.flag == 11)
    {
      res.accel[0] -= motion_intrinsics->accel.x[1] * temp + motion_intrinsics->accel.x[0];
  ...
  bool getParams(
      ...
      mynteye_wrapper_d::GetParams::Response &res)
  { // NOLINT
    ...
    case Request::IMG_INTRINSICS:
    {
      ...
      if (params.stream_mode == StreamMode::STREAM_1280x480 && in_ok_1)
      {
        Config intrinsics{
            {"calib_model", "pinhole"},
            {"left", {
                         {"width", in_vga.left.width}, {"height", in_vga.left.height}, {"fx", in_vga.left.fx}, {"fy", in_vga.left.fy}, {"cx", in_vga.left.cx}, {"cy", in_vga.left.cy}, {"coeffs", Config::array({in_vga.left.coeffs[0], in_vga.left.coeffs[1], in_vga.left.coeffs[2], in_vga.left.coeffs[3], in_vga.left.coeffs[4]})}, {"p", Config::array({in_vga.left.p[0], in_vga.left.p[1], in_vga.left.p[2],     // NOLINT
            ...
            {"right", {
                          {"width", in_vga.right.width}, {"height", in_vga.right.height}, {"fx", in_vga.right.fx}, {"fy", in_vga.right.fy}, {"cx", in_vga.right.cx}, {"cy", in_vga.right.cy}, {"coeffs", Config::array({in_vga.right.coeffs[0], in_vga.right.coeffs[1], in_vga.right.coeffs[2], in_vga.right.coeffs[3], in_vga.right.coeffs[4]})}, {"p", Config::array({in_vga.right.p[0], in_vga.right.p[1], in_vga.right.p[2],     // NOLINT
               ...
               in_ok_2)
      {
        Config intrinsics{
            {"calib_model", "pinhole"},
            {"left", {
                         {"width", in_hd.left.width}, {"height", in_hd.left.height}, {"fx", in_hd.left.fx}, {"fy", in_hd.left.fy}, {"cx", in_hd.left.cx}, {"cy", in_hd.left.cy}, {"coeffs", Config::array({in_hd.left.coeffs[0], in_hd.left.coeffs[1], in_hd.left.coeffs[2], in_hd.left.coeffs[3], in_hd.left.coeffs[4]})}, {"p", Config::array({in_hd.left.p[0], in_hd.left.p[1], in_hd.left.p[2],     // NOLINT
            ...
            {"right", {
                          {"width", in_hd.right.width}, {"height", in_hd.right.height}, {"fx", in_hd.right.fx}, {"fy", in_hd.right.fy}, {"cx", in_hd.right.cx}, {"cy", in_hd.right.cy}, {"coeffs", Config::array({in_hd.right.coeffs[0], in_hd.right.coeffs[1], in_hd.right.coeffs[2], in_hd.right.coeffs[3], in_hd.right.coeffs[4]})}, {"p", Config::array({in_hd.right.p[0], in_hd.right.p[1], in_hd.right.p[2],     // NOLINT
